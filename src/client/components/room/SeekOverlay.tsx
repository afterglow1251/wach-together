  ...
  return (
    <>
      ...
      <div
        ...
        style={{ background: "radial-gradient(ellipse at 20% 50%, rgba(232, 67, 147, 0.1) 0%, rgba(0, 0, 0, 0.4) 100%)" }}
      >
        <div class="absolute w-[100px] h-[100px] rounded-full bg-accent/20" style={{ animation: dir() === "left" ? "seek-ripple 0.5s ease-out" : "none", transform: "scale(0)" }} />
      ...
      <div
        ...
        style={{ background: "radial-gradient(ellipse at 80% 50%, rgba(232, 67, 147, 0.1) 0%, rgba(0, 0, 0, 0.4) 100%)" }}
      >
        <div class="absolute w-[100px] h-[100px] rounded-full bg-accent/20" style={{ animation: dir() === "right" ? "seek-ripple 0.5s ease-out" : "none", transform: "scale(0)" }} />
        <div class="flex flex-col items-center gap-1.5 z-1">
          <div class="flex gap-1">
            {hearts.map((n) => (
              <HeartIcon
